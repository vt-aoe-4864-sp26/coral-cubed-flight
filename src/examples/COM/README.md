...
Radio communication (COM) board software.

**Dependencies**

* A cross-compiler for the COM micocontroller unit (MCU) (i.e., AArch32
  bare-metal target)
...
loading a "blink" example onto the COM board.
...
* [scripts](scripts/README.md): Scripts and other files supporting COM software
