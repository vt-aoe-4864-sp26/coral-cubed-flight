...
class recieve_noise(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "recieve_noise")
        ...
        self.soapy_hackrf_source_0.set_frequency(0, 433000000)
...
def main(top_block_cls=recieve_noise, options=None):
