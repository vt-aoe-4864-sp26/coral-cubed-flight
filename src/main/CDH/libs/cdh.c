...
int cdh_flash_test_deadbeef(void)
{
    ...
    const off_t test_offset = 0x00100000;   /* reserved test address in external QSPI flash */
    const size_t erase_size = 4096;         /* 4 KB sector erase for IS25LP128F */
